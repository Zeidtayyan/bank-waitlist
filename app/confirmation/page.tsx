    ...
    return(
        <div className="h-screen bg-blue-200 flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-gray-800">
                <h1 className="text-3xl font-bold text-center mb-6">Booking Confirmed!</h1>
                <div className="flex flex-col gap-3">
                    ...
                    <button onClick={() => router.push("/")} className="w-full mt-6 bg-blue-700 text-white py-2 rounded-md font-semibold hover:bg-blue-800">Make Another Booking</button>
                </div>
            </div>
        </div>
    )
